    ...
    return (
        <div className="relative lg:pb-10 min-h-screen items-center">
            ...
            <div className="bg-secondaryTur min-h-screen flex flex-col justify-center lg:hidden relative items-top bg-none">
                ...
                <div className=" w-full relative"> {/* Añadido relative aquí */}
                    <img
                        src={Recuadrotesti}
                        alt="Recuadro Testimonios"
                        className="mt-2 w-6/7 h-auto mx-auto pl-7"
                    />
                    <div className="absolute top-0 left-0 w-full"> {/* Contenedor para el slider */}
                        <Slider {...settings}>
                            {reviewsToShow.map((review, index) => (
                                <div className="flex flex-col items-center text-center pt-12 px-10" key={index}>
                                    <div>
                                       {/*  <Avatar
                                            src={review.avatar}
                                            alt="image"
                                            ...
                                            className="mb-4"
                                        />*/}
                                        <Typography variant="p" className="mt-9 mb-4 text-colorText font-m text-sm md:text-lg lg:text-base">
                                            &quot;{review.author}&quot;
                                        </Typography>
                                    </div>
