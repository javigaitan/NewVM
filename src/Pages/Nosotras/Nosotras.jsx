    ...
    return (
            ...
            <div className="py-20 2xl:px-0 lg:px-12 px-4 2xl:mx-auto 2xl:container bg-gray-50" style={{ height: 1000 }}>
                <div className="md:flex items-center justify-between w-full bg-gray-50">
                    <div className="xl:w-1/3 md:w-1/2 w-full">
                        <h1 role="heading" className="focus:outline-none md:w-60 font- md:text-6xl text-4xl leading-tight text-purple-900">
                            De corazón viajero y aventurero

                        </h1>

                        <div className="mt-10">
                            <p className="flex items-center md:p-3 p-1 focus:outline-none text-l font- leading-5 text-gray-800 focus:ring-2 focus:ring-offset-2 focus:ring-gray-700">
                                ...
                                Desde nuestra sede en Irlanda y con representantes en distintos países, asesoramos gratuitamente a personas de todo el mundo 24/7 con más de 5 años de experiencia.
        ...
        <div>
            <div className="container flex justify-center mx-auto pt-16">
                <div>
                    <h1 className="xl:text-4xl text-3xl text-center text-purple-900 font-bold pb-6 sm:w-4/6 w-5/6 mx-auto">Vaga-Mundo es equipo
</h1>
                </div>
            </div>
