        ...
        <div className=" dark:bg-gray-900 items-center">
            <div>
                ...
                <div className="text w-full bg-primaryVio px-4 py-8 text-center rounded-b-[50px]  " style={{ paddingLeft: '80px' }}>
                    <h1 className="text-6xl font-bold text-colorWhite dark:text-white mb-10 pt-14">Vaga Mundo 
                    </h1>
            ...
            <div className="container mx-auto px-4 py-7">
                ...
                <div className=" w-full  px-4 py-8 text-center">
                    <h1 className="lg:text-5xl md:text-4xl text-2xl font-semibold leading-10 text-primaryVio mt-6 text-center">Gracias por dejarnos tus datos ! 
                    </h1>
