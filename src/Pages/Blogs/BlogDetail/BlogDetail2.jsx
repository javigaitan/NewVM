        ...
        <div className=" dark:bg-gray-900 items-center">
            ...
            <div className="container mx-auto px-4 py-7">
                ...
                <div className=" w-full  px-4 py-8 text-center">
                    <h1 className="lg:text-5xl md:text-4xl text-2xl font-semibold leading-10 text-primaryVio mt-6 text-center">Guía Completa para
                    </h1>
                    <h1 className="lg:text-5xl md:text-4xl text-2xl  leading-10 text-primaryVio mt-6 text-center">
                        <br /> Estudiar y Trabajar en Irlanda <img src={IrlandaBandera} alt="Bandera de Irlanda" className="w-12 h-10 inline-block mx-2" /> </h1>
                </div>

                <p className=" text-lg leading-6 text-colorText mt-6">Si estás buscando una experiencia única para mejorar tu inglés o realizar estudios superiores, Irlanda es el destino perfecto para ti. Con su sistema educativo de alta calidad, paisajes impresionantes y una cultura vibrante, este país ofrece una excelente oportunidad para combinar aprendizaje, trabajo y aventura. Estudiar en Irlanda te abrirá puertas tanto académicas como profesionales, mientras te sumerges en una de las naciones más acogedoras de Europa.
            ...
            <div className="container mx-auto px-4 py-7">
                ...
                <div className=" w-full  px-4 py-8 text-center">
                    ...
                    <h1 className="lg:text-5xl md:text-4xl text-2xl  leading-10 text-primaryVio mt-6 text-center">
                        ...
                        Comienza tu experiencia en Irlanda <img src={IrlandaBandera} alt="Bandera de Irlanda" className="w-12 h-10 inline-block mx-2" /> </h1>
                </div>

                <p className=" text-lg leading-6 text-colorText mt-6">Estudiar y trabajar en Irlanda es una experiencia única que te ofrece la oportunidad de aprender un idioma, realizar estudios superiores o incluso especializarte en áreas de interés profesional. Ya sea que quieras mejorar tus habilidades lingüísticas, ampliar tus conocimientos en una carrera o ganar experiencia internacional, Irlanda tiene todo lo que necesitas para crecer personal y profesionalmente. Te ayudamos a organizar todo para que puedas concentrarte en lo que realmente importa: disfrutar de tu estancia mientras aprendes, te desarrollas y te sumerges en una cultura fascinante.


                    <br /><br />¿Listo para comenzar tu viaje educativo? Contáctanos y planifica con nosotros esta experiencia que cambiará tu vida.
