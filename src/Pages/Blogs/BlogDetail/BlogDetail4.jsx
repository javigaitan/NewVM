...
const BlogDetail4 = () => {
            ...
            <div className="container mx-auto px-4 py-7">
                ...
                <div className=" w-full  px-4 py-8 text-center">
                    <h1 className="lg:text-5xl md:text-4xl text-2xl font-semibold leading-10 text-primaryVio mt-6 text-center">
                        Disfruta de la auténtica gastronomía irlandesa:
                        <br />Un viaje de sabores

                    </h1>
                </div>

                <p className=" text-lg leading-6 text-colorText mt-6">
                    Al llegar a Irlanda, puede ser complicado adaptarse a su gastronomía. Los latinos, conocidos por ser exigentes con los sabores y texturas de los alimentos, a veces encontramos difícil encontrar ese toque familiar en los platos locales.
                    <br />                 <br />

                    Sin embargo, en <strong>Vaga-Mundo</strong>, como tu agencia de turismo educativo, te damos algunas recomendaciones para que empieces a disfrutar de la deliciosa comida típica irlandesa. ¡Te aseguramos que pronto te encantarán estos sabores!
                </p>
            ...
            <div className="container mx-auto px-4 py-7">
                ...
                <div className=" w-full  px-4 py-8 text-center">
                    <h2 className="lg:text-5xl md:text-4xl text-2xl font-semibold leading-10 text-primaryVio mt-6 text-center">
                        Comida típica irlandesa para el día a día

                    </h2>
                </div>

                <p className=" text-lg leading-6 text-colorText mt-6">
                    Al llegar a Irlanda, es común preguntarse: "¿Qué comen los irlandeses?". La respuesta es simple: ¡Aman las patatas! Las papas son la base de casi todos los platillos irlandeses, y no es para menos, ya que se preparan de tantas formas que nunca te aburrirás de ellas. A continuación, se presentan algunos de los platos más populares:
                    <br />                 <br />
                ...
                <div className="space-y-6 max-w-[980px] mx-auto pl-5">
                    <div className="flex items-start">
                        ...
                        <p className="text-gray-700 text-left w-full md:w-[100%] pl-3">
                            <span className="font-semibold">Irish Stew:</span>
                            El Irish Stew es el plato nacional de Irlanda. Este estofado se elabora con carne de cordero, papas, cebollas y perejil. ¡Un plato reconfortante que refleja la tradición irlandesa!
                        </p>
                    </div>
                    ...
                    <div className="flex items-start">
                        <span className="text-secondaryTur2 text-2xl font-bold">✓</span>
                        <p className="text-gray-700 text-left w-full md:w-[100%] pl-3">
                            <span className="font-semibold">Bacon and Cabbage:</span>
                            Este platillo consiste en tocino acompañado de col y, por supuesto, papas. Un clásico que no puede faltar en la mesa irlandesa.
                        </p>
                    </div>
                    ...
                    <div className="flex items-start">
                        <span className="text-secondaryTur2 text-2xl font-bold">✓</span>
                        <p className="text-gray-700 text-left w-full md:w-[100%] pl-3">
                            <span className="font-semibold">Seafood Chowder:</span>
                            Una deliciosa sopa de mariscos cremosa, que contiene camarones y diversos moluscos frescos. Ideal para los amantes del marisco.
                        </p>
                    </div>
                    ...
                    <div className="flex items-start">
                        <span className="text-secondaryTur2 text-2xl font-bold">✓</span>
                        <p className="text-gray-700 text-left w-full md:w-[100%] pl-3">
                            <span className="font-semibold">Cottage Pie:</span>
                            Este es un pastel salado relleno de carne picada (generalmente cordero, pero hoy en día también se puede encontrar con carne de res o pollo). Lo mejor de este platillo es que está cubierto por un cremoso puré de papas.
                        </p>
                    </div>
                </div>
    ...
    {/* Flex layout for lg, centered for md */}
    <div className="w-full px-4 py-8 text-center">
        <h3 className="lg:text-4xl md:text-3xl text-2xl font-semibold leading-10 text-primaryVio mt-6 text-center">
            Acompañantes y ensaladas irlandesas
        </h3>
    </div>
    ...
    <div className="space-y-6 max-w-[980px] mx-auto pl-5">
        ...
        <div className="flex items-start">
            ...
            <div className="container mx-auto px-4 py-7">
                ...
                <p className=" text-lg leading-6 text-colorText mt-6">
                    Consejo <strong>Vaga-Mundo </strong>: No olvides probar estos platillos durante tu estancia en Irlanda. Con el paso del tiempo, te irás acostumbrando y disfrutarás cada vez más de la comida local. ¡Asegúrate de compartir tus experiencias gastronómicas con nosotros!

                    <br /><br />
                    Si estás pensando en estudiar en Irlanda y disfrutar de su cultura al máximo, no dudes en contactarnos. En <strong>Vaga-Mundo </strong> te ayudamos a organizar tu experiencia educativa en Irlanda, ¡y a descubrir todos los sabores que este hermoso país tiene para ofrecer!
