...
const BlogDetail4 = () => {
    ...
    const steps = [
        {
            title: "1. Permiso de conducir",
            description:
                "Estancias cortas (menos de 12 meses): Puedes usar el permiso de tu país de origen o un Permiso Internacional de Conducir (PIC), especialmente si tu licencia no está en inglés.   Estancias largas (más de 12 meses): Necesitarás obtener una licencia de conducir irlandesa. Consulta el sitio web de la National Driver Licence Service (NDLS) para más información.",
        },
        {
            title: "2. Seguro de automóvil",
            description:
                "Obligatorio en Irlanda. Si alquilas un coche, la empresa te proporcionará un seguro básico, pero considera adquirir una cobertura adicional.",
        },
        {
            title: "3. Documentación del vehículo",
            description:
                "Lleva contigo el certificado de matriculación (logbook) y la tarjeta de inspección técnica si aplica.",
        },
        {
        ...
        {
            title: "5. Otros requisitos",
            description:
                "Edad mínima de 21 años para conductores extranjeros con licencia de su país de origen, buen estado físico y mental para manejar con seguridad.Tolerancia cero al consumo de alcohol y drogas al volante.",
        },
    ...
    return (
        <div className=" dark:bg-gray-900 items-center">
            ...
            <div className="container mx-auto px-4 py-7">
                ...
                <div className=" w-full  px-4 py-8 text-center">
                    <h1 className="lg:text-5xl md:text-4xl text-2xl font-semibold leading-10 text-primaryVio mt-6 text-center">
                        Guía para Conducir en Irlanda: <br />Requisitos, Normas y Consejos para tu Viaje
                    </h1>
                </div>

                <p className=" text-lg leading-6 text-colorText mt-6">
                    Conducir en Irlanda te brinda la libertad de recorrer la isla a tu ritmo, descubrir paisajes impresionantes y sumergirte en su cultura. Para que tu experiencia sea segura y placentera, hemos preparado esta guía con toda la información esencial.
                    <br />                 <br />

                    Desde normas de tránsito hasta consejos prácticos, aquí encontrarás todo lo que necesitas saber antes de ponerte al volante. ¡Abróchate el cinturón y acompáñanos en este recorrido!
                </p>
            ...
            <div className="container mx-auto px-4 py-7">
                ...
                <div className=" w-full  px-4 py-8 text-center">
                    <h2 className="lg:text-5xl md:text-4xl text-2xl font-semibold leading-10 text-primaryVio mt-6 text-center">
                        ¿Cómo se conduce en Irlanda?                    </h2>
                </div>

                <p className=" text-lg leading-6 text-colorText mt-6">
                    En Irlanda, al igual que en el Reino Unido, se conduce por la izquierda. Al principio puede parecer desafiante, pero con algo de práctica te adaptarás rápidamente. Ten en cuenta que el volante está a la derecha y la palanca de cambios a tu izquierda.
                    <br />                 <br />

                    Las rotondas son muy comunes, y la norma principal es ceder el paso a los vehículos que ya están dentro de ellas. Además, las distancias y límites de velocidad se indican en kilómetros por hora, así que no te confundas con las millas.
                </p>
            ...
            <div className="container mx-auto px-4 py-7">
                ...
                <div className=" w-full  px-4 py-8 text-center">
                    <h2 className="lg:text-5xl md:text-4xl text-2xl font-semibold leading-10 text-primaryVio mt-6 text-center">
                    Requisitos para Conducir en Irlanda
                    </h2>
                </div>

                <p className=" text-lg leading-6 text-colorText mt-6">
                Para manejar sin inconvenientes, es fundamental cumplir con ciertos requisitos legales:                    <br />                 <br />
