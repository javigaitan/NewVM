...
import Diplomaturas from '../../../assets/ServiciosVM/España/cursos y diploma superiores.png';
    ...
    <div>
        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="w-full lg:w-1/2 p-4 flex flex-col justify-center items-center lg:items-start text-center lg:text-left lg:hidden">
                    <h1 className="text-4xl font-bold mb-3  text-primaryVio">{t("experiencesEs.experiences2.title")}</h1>
                    </div>

            <div className="flex flex-col md:flex-col lg:flex-row items-center lg:items-start">
                <div className="w-full lg:w-1/2 p-4 flex justify-center">
                    <img src={Diplomaturas} alt="Diplomaturas" className="w-full h-auto" />
                </div>
                <div className="w-full lg:w-1/2 p-4 flex flex-col justify-center items-center lg:items-start text-center lg:text-left">
                    <h1 className="text-4xl font-bold mb-3 pb-5 text-primaryVio hidden lg:block">{t("experiencesEs.experiences2.title")}</h1>
                    <p className="text-lg text-colorText">
                    {t("experiencesEs.experiences2.text1")}                        <br />
                        <br />{t("experiencesEs.experiences2.text2")}
                        <br />
                        <br />{t("experiencesEs.experiences2.text3")}
...
export default AdvancedDiplomas